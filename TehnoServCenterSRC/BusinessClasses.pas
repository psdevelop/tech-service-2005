...
function TPoljzovatelj._Get_M_Login: TBAString;
begin
  assert(ValidateMember('TPoljzovatelj', 'Login', 26, TBAString));
  Result := TBAString(BoldMembers[26]);
end;

function TPoljzovatelj._GetLogin: String;
begin
  Result := M_Login.AsString;
end;

procedure TPoljzovatelj._SetLogin(const NewValue: String);
begin
  M_Login.AsString := NewValue;
end;

function TPoljzovatelj._Get_M_Parolj: TBAString;
begin
  assert(ValidateMember('TPoljzovatelj', 'Parolj', 27, TBAString));
  Result := TBAString(BoldMembers[27]);
end;

function TPoljzovatelj._GetParolj: String;
begin
  Result := M_Parolj.AsString;
end;

procedure TPoljzovatelj._SetParolj(const NewValue: String);
begin
  M_Parolj.AsString := NewValue;
end;

function TPoljzovatelj._Get_M_Prava: TBAInteger;
begin
  assert(ValidateMember('TPoljzovatelj', 'Prava', 28, TBAInteger));
  Result := TBAInteger(BoldMembers[28]);
end;

function TPoljzovatelj._GetPrava: Integer;
begin
  Result := M_Prava.AsInteger;
end;

procedure TPoljzovatelj._SetPrava(const NewValue: Integer);
begin
  M_Prava.AsInteger := NewValue;
end;

procedure TPoljzovateljList.Add(NewObject: TPoljzovatelj);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TPoljzovateljList.IndexOf(anObject: TPoljzovatelj): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TPoljzovateljList.Includes(anObject: TPoljzovatelj) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TPoljzovateljList.AddNew: TPoljzovatelj;
begin
  result := TPoljzovatelj(InternalAddNew);
end;

procedure TPoljzovateljList.Insert(index: Integer; NewObject: TPoljzovatelj);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TPoljzovateljList.GetBoldObject(index: Integer): TPoljzovatelj;
begin
  result := TPoljzovatelj(GetElement(index));
end;

procedure TPoljzovateljList.SetBoldObject(index: Integer; NewObject: TPoljzovatelj);
begin;
  SetElement(index, NewObject);
end;
...
begin
  ...
  BoldObjectListClasses.AddObjectEntry('Poljzovatelj', TPoljzovateljList);
...
begin
  ...
  BoldObjectClasses.AddObjectEntry('Poljzovatelj', TPoljzovatelj);
